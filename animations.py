...
def generate_animations(player):
    ...
    # Punch right
    punch_right_animation_frames = generate_frame_set_from_dir("resources/player/punch_r", default_offset, size, [None, None, player.call_hit, None, player.reset_animation], player)
    punch_right_animation = Animation(punch_right_animation_frames, False, 12)

    # Punch left
    punch_left_animation_frames = generate_frame_set_from_dir("resources/player/punch_l", default_offset, size, [None, None, player.call_hit, None, player.reset_animation], player)
    punch_left_animation = Animation(punch_left_animation_frames, False, 12)

    # Kick right
    kick_right_animation_frames = generate_frame_set_from_dir("resources/player/kick_r", default_offset, size, [None, None, None, None, None, None, None, None, None, player.call_hit, None, None, None, None, None, player.reset_animation], player)
    kick_right_animation = Animation(kick_right_animation_frames, False, 24)

    # Kick left
    kick_left_animation_frames = generate_frame_set_from_dir("resources/player/kick_l", default_offset, size, [None, None, None, None, None, None, None, None, None, player.call_hit, None, None, None, None, None, player.reset_animation], player)
    ...
    # Crouch punch right
    crouch_punch_right_animation_frames = generate_frame_set_from_dir("resources/player/crouch_punch_r", default_offset, size, [None, None, None, None, None, None, None, player.call_hit, None, None, None, None, player.reset_animation], player)
    crouch_punch_right_animation = Animation(crouch_punch_right_animation_frames, False, 24)

    # Crouch punch left
    crouch_punch_left_animation_frames = generate_frame_set_from_dir("resources/player/crouch_punch_l", default_offset, size, [None, None, None, None, None, None, None, player.call_hit, None, None, None, None, player.reset_animation], player)
    crouch_punch_left_animation = Animation(crouch_punch_left_animation_frames, False, 24)

    # Crouch kick right
    crouch_kick_right_animation_frames = generate_frame_set_from_dir("resources/player/crouch_kick_r", default_offset, size, [None, None, None, player.call_hit, None, None, player.reset_animation], player)
    crouch_kick_right_animation = Animation(crouch_kick_right_animation_frames, False, 12)

    # Crouch kick left
    crouch_kick_left_animation_frames = generate_frame_set_from_dir("resources/player/crouch_kick_l", default_offset, size, [None, None, None, player.call_hit, None, None, player.reset_animation], player)
    ...
    # Jump punch right
    jump_punch_right_animation_frames = generate_frame_set_from_dir("resources/player/jump_punch_r", default_offset, size, [None, None, player.call_hit, None, player.reset_animation], player)
    jump_punch_right_animation = Animation(jump_punch_right_animation_frames, False, 24)

    # Jump punch left
    jump_punch_left_animation_frames = generate_frame_set_from_dir("resources/player/jump_punch_l", default_offset, size, [None, None, player.call_hit, None, player.reset_animation], player)
    jump_punch_left_animation = Animation(jump_punch_left_animation_frames, False, 24)

    # Jump kick right
    jump_kick_right_animation_frames = generate_frame_set_from_dir("resources/player/jump_kick_r", default_offset, size, [None, None, None, None, None, None, None, player.call_hit, None, None, player.reset_animation], player)
    jump_kick_right_animation = Animation(jump_kick_right_animation_frames, False, 24)

    # Jump kick left
    jump_kick_left_animation_frames = generate_frame_set_from_dir("resources/player/jump_kick_l", default_offset, size, [None, None, None, None, None, None, None, player.call_hit, None, None, player.reset_animation], player)
