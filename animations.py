...
def generate_frame_set_from_dir(path, offset, codes, player):
    m = []
    for i, name in enumerate(os.listdir(path)):
        m.append(AnimationFrame(path+"/"+name, offset, codes[i], player))
    return m

def generate_animations(player):
    # Idle right
    idle_right_animation_frames = generate_frame_set_from_dir("resources/player/idle_r", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    idle_right_animation = Animation(idle_right_animation_frames, True, 12)

    # Idle left
    idle_left_animation_frames = generate_frame_set_from_dir("resources/player/idle_l", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    ...
    # Run left
    run_left_animation_frames = generate_frame_set_from_dir("resources/player/run_l", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    run_left_animation = Animation(run_left_animation_frames, True, 24)

    # Crouch right
    crouch_right_animation_frames = generate_frame_set_from_dir("resources/player/crouch_r", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    crouch_right_animation = Animation(crouch_right_animation_frames, True, 12)

    # Crouch left
    crouch_left_animation_frames = generate_frame_set_from_dir("resources/player/crouch_l", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    ...
    # Crawl right
    crawl_right_animation_frames = generate_frame_set_from_dir("resources/player/crawl_r", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    crawl_right_animation = Animation(crawl_right_animation_frames, True, 10)

    # Crawl left
    crawl_left_animation_frames = generate_frame_set_from_dir("resources/player/crawl_l", Vector([-45, -40]), [None, None, None, None, None, None, None, None, None, None, None, None, None], player)
    crawl_left_animation = Animation(crawl_left_animation_frames, True, 10)

    # Jump right
    jump_right_animation_frames = generate_frame_set_from_dir("resources/player/jump_r", Vector([-45, -40]), [None], player)
    jump_right_animation = Animation(jump_right_animation_frames, True, 12)

    # Jump left
    jump_left_animation_frames = generate_frame_set_from_dir("resources/player/jump_l", Vector([-45, -40]), [None], player)
